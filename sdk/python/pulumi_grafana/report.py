...
class ReportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] layout: Layout of the report. `simple` or `grid`
        :param pulumi.Input[str] message: Message to be sent in the report.
        :param pulumi.Input[str] name: Name of the report.
        :param pulumi.Input[str] orientation: Orientation of the report. `landscape` or `portrait`
    ...
    def dashboard_id(self) -> pulumi.Input[int]:
        """
    ...
    @dashboard_id.setter
    def dashboard_id(self, value: pulumi.Input[int]):
