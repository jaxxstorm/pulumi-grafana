...
class DataSourceArgs:
    def __init__(__self__, *,
        ...
        if basic_auth_password is not None:
            warnings.warn("""Use secure_json_data.basic_auth_password instead. This attribute is removed in Grafana 9.0+.""", DeprecationWarning)
            pulumi.log.warn("""basic_auth_password is deprecated: Use secure_json_data.basic_auth_password instead. This attribute is removed in Grafana 9.0+.""")
        if basic_auth_password is not None:
        ...
        if password is not None:
            warnings.warn("""Use secure_json_data.password instead. This attribute is removed in Grafana 9.0+.""", DeprecationWarning)
            pulumi.log.warn("""password is deprecated: Use secure_json_data.password instead. This attribute is removed in Grafana 9.0+.""")
        if password is not None:
