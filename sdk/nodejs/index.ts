...
import { OutgoingWebhook } from "./outgoingWebhook";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "grafana:index/externalGroup:ExternalGroup":
                return new ExternalGroup(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("grafana", "index/externalGroup", _module)
...
pulumi.runtime.registerResourceModule("grafana", "index/oncallShift", _module)
pulumi.runtime.registerResourceModule("grafana", "index/organization", _module)
pulumi.runtime.registerResourceModule("grafana", "index/outgoingWebhook", _module)
