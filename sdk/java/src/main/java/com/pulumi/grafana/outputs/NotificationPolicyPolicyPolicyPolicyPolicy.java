...
import com.pulumi.grafana.outputs.NotificationPolicyPolicyPolicyPolicyPolicyMatcher;
...
public final class NotificationPolicyPolicyPolicyPolicyPolicy {
    ...
    public static Builder builder(NotificationPolicyPolicyPolicyPolicyPolicy defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repeatInterval;
        public Builder() {}
        public Builder(NotificationPolicyPolicyPolicyPolicyPolicy defaults) {
        ...
        @CustomType.Setter
        public Builder matchers(@Nullable List<NotificationPolicyPolicyPolicyPolicyPolicyMatcher> matchers) {
            this.matchers = matchers;
            return this;
        }
        public Builder matchers(NotificationPolicyPolicyPolicyPolicyPolicyMatcher... matchers) {
        ...
        public NotificationPolicyPolicyPolicyPolicyPolicy build() {
            final var o = new NotificationPolicyPolicyPolicyPolicyPolicy();
