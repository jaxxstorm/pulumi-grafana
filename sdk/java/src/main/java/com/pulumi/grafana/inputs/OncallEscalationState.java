...
public final class OncallEscalationState extends com.pulumi.resources.ResourceArgs {

    public static final OncallEscalationState Empty = new OncallEscalationState();
    ...
    private OncallEscalationState() {}

    private OncallEscalationState(OncallEscalationState $) {
    ...
    public static Builder builder(OncallEscalationState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OncallEscalationState();
        }

        public Builder(OncallEscalationState defaults) {
            $ = new OncallEscalationState(Objects.requireNonNull(defaults));
        }
        ...
        public OncallEscalationState build() {
            return $;
        }
    }
