...
public final class OncallShiftState extends com.pulumi.resources.ResourceArgs {

    public static final OncallShiftState Empty = new OncallShiftState();
    ...
    private OncallShiftState() {}

    private OncallShiftState(OncallShiftState $) {
        this.byDays = $.byDays;
    ...
    public static Builder builder(OncallShiftState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OncallShiftState();
        }

        public Builder(OncallShiftState defaults) {
            $ = new OncallShiftState(Objects.requireNonNull(defaults));
        }
