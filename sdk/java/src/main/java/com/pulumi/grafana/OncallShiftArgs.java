...
public final class OncallShiftArgs extends com.pulumi.resources.ResourceArgs {

    public static final OncallShiftArgs Empty = new OncallShiftArgs();
    ...
    private OncallShiftArgs() {}

    private OncallShiftArgs(OncallShiftArgs $) {
        this.byDays = $.byDays;
    ...
    public static Builder builder(OncallShiftArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(OncallShiftArgs defaults) {
            $ = new OncallShiftArgs(Objects.requireNonNull(defaults));
        }
