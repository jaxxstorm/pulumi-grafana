...
import com.pulumi.grafana.outputs.NotificationPolicyPolicyPolicyMatcher;
import com.pulumi.grafana.outputs.NotificationPolicyPolicyPolicyPolicy;
...
@CustomType
public final class NotificationPolicyPolicyPolicy {
    ...
    private @Nullable List<NotificationPolicyPolicyPolicyMatcher> matchers;
    private @Nullable List<String> muteTimings;
    private @Nullable List<NotificationPolicyPolicyPolicyPolicy> policies;
    ...
    public List<NotificationPolicyPolicyPolicyMatcher> matchers() {
    ...
    public List<NotificationPolicyPolicyPolicyPolicy> policies() {
    ...
    public static Builder builder(NotificationPolicyPolicyPolicy defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repeatInterval;
        public Builder() {}
        public Builder(NotificationPolicyPolicyPolicy defaults) {
        ...
        @CustomType.Setter
        public Builder matchers(@Nullable List<NotificationPolicyPolicyPolicyMatcher> matchers) {
            this.matchers = matchers;
            return this;
        }
        public Builder matchers(NotificationPolicyPolicyPolicyMatcher... matchers) {
        ...
        @CustomType.Setter
        public Builder policies(@Nullable List<NotificationPolicyPolicyPolicyPolicy> policies) {
            this.policies = policies;
            return this;
        }
        public Builder policies(NotificationPolicyPolicyPolicyPolicy... policies) {
        ...
        public NotificationPolicyPolicyPolicy build() {
            final var o = new NotificationPolicyPolicyPolicy();
