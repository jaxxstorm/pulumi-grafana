...
public final class ExternalGroupArgs extends com.pulumi.resources.ResourceArgs {

    public static final ExternalGroupArgs Empty = new ExternalGroupArgs();
    ...
    private ExternalGroupArgs() {}

    private ExternalGroupArgs(ExternalGroupArgs $) {
        this.groups = $.groups;
        this.teamId = $.teamId;
    }
    ...
    public static Builder builder(ExternalGroupArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ExternalGroupArgs();
        }

        public Builder(ExternalGroupArgs defaults) {
            $ = new ExternalGroupArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ExternalGroupArgs build() {
