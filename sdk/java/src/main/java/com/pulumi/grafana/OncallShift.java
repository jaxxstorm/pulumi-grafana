...
import com.pulumi.grafana.OncallShiftArgs;
import com.pulumi.grafana.Utilities;
import com.pulumi.grafana.inputs.OncallShiftState;
...
public class OncallShift extends com.pulumi.resources.CustomResource {
     ...
     */
    public OncallShift(String name) {
        this(name, OncallShiftArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public OncallShift(String name, OncallShiftArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("grafana:index/oncallShift:OncallShift", name, args == null ? OncallShiftArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OncallShift(String name, Output<String> id, @Nullable OncallShiftState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("grafana:index/oncallShift:OncallShift", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static OncallShift get(String name, Output<String> id, @Nullable OncallShiftState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
