...
import com.pulumi.grafana.inputs.NotificationPolicyPolicyMatcherArgs;
import com.pulumi.grafana.inputs.NotificationPolicyPolicyPolicyArgs;
...
public final class NotificationPolicyPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final NotificationPolicyPolicyArgs Empty = new NotificationPolicyPolicyArgs();
    ...
    private @Nullable Output<List<NotificationPolicyPolicyMatcherArgs>> matchers;

    public Optional<Output<List<NotificationPolicyPolicyMatcherArgs>>> matchers() {
    ...
    private @Nullable Output<List<NotificationPolicyPolicyPolicyArgs>> policies;

    public Optional<Output<List<NotificationPolicyPolicyPolicyArgs>>> policies() {
    ...
    private NotificationPolicyPolicyArgs() {}

    private NotificationPolicyPolicyArgs(NotificationPolicyPolicyArgs $) {
    ...
    public static Builder builder(NotificationPolicyPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NotificationPolicyPolicyArgs();
        }

        public Builder(NotificationPolicyPolicyArgs defaults) {
            $ = new NotificationPolicyPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder matchers(@Nullable Output<List<NotificationPolicyPolicyMatcherArgs>> matchers) {
            $.matchers = matchers;
            return this;
        }

        public Builder matchers(List<NotificationPolicyPolicyMatcherArgs> matchers) {
            return matchers(Output.of(matchers));
        }

        public Builder matchers(NotificationPolicyPolicyMatcherArgs... matchers) {
        ...
        public Builder policies(@Nullable Output<List<NotificationPolicyPolicyPolicyArgs>> policies) {
            $.policies = policies;
            return this;
        }

        public Builder policies(List<NotificationPolicyPolicyPolicyArgs> policies) {
            return policies(Output.of(policies));
        }

        public Builder policies(NotificationPolicyPolicyPolicyArgs... policies) {
        ...
        public NotificationPolicyPolicyArgs build() {
