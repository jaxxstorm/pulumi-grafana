...
public final class ContactPointArgs extends com.pulumi.resources.ResourceArgs {

    public static final ContactPointArgs Empty = new ContactPointArgs();
    ...
    private ContactPointArgs() {}

    private ContactPointArgs(ContactPointArgs $) {
    ...
    public static Builder builder(ContactPointArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ContactPointArgs();
        }

        public Builder(ContactPointArgs defaults) {
            $ = new ContactPointArgs(Objects.requireNonNull(defaults));
        }
