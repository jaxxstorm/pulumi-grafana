...
namespace Pulumi.Grafana
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Grafana.version.txt");
    ...
    internal sealed class GrafanaResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public GrafanaResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
