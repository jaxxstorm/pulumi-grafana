...
namespace Pulumi.Grafana
{
    ...
    public partial class OncallShift : global::Pulumi.CustomResource
    {
        ...
        public OncallShift(string name, OncallShiftArgs args, CustomResourceOptions? options = null)
            : base("grafana:index/oncallShift:OncallShift", name, args ?? new OncallShiftArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OncallShift(string name, Input<string> id, OncallShiftState? state = null, CustomResourceOptions? options = null)
            : base("grafana:index/oncallShift:OncallShift", name, state, MakeResourceOptions(options, id))
        {
        }
